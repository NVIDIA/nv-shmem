...
int main()
{
    ...
    {
        std::cout
            << "AggregationService::updateTelemetry success for new object"
            << std::endl;
    }
    else
    {
    ...
    for (size_t i = 0; i < 10; i++)
    {
        ...
        {
            std::cout
                << "AggregationService::updateTelemetry value and timestamp "
                   "update success"
                << std::endl;
        }
        else
    ...
    timeStamp = 23150448;
    if (AggregationService::updateTelemetry(tmpDevicePath, interface,
                                            propertyName, tmpValue, timeStamp,
                                            0, tmpParentPath))
    {
        std::cout
            << "AggregationService::updateTelemetry timestamp update success."
            << std::endl;
    }
    else
    {
        std::cout
            << "AggregationService::updateTelemetry timestamp update failed."
            << std::endl;
    }
    ...
    {
        std::cout
            << "AggregationService::updateTelemetry not applicable key test "
               "success."
            << std::endl;
    }
    else
    ...
    {
        std::cout
            << "AggregationService: array properties dynamic change handling "
               "test success"
            << std::endl;
    }
    else
    ...
    {
        std::cout << "AggregationService:  GPMMetrics test success"
                  << std::endl;
    }
    else
    {
